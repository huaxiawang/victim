			...
			<ol class="property-list employee">
				...
				<li class="fieldcontain">
					<span id="profile-label" class="property-label"><g:message code="employee.profile.label" default="Profile" /></span>
						...
						<span class="property-value" aria-labelledby="profile-label"><g:link controller="profile" action="show" id="${employeeInstance?.profile?.id}">${employeeInstance?.profile?.encodeAsHTML()}</g:link></span>
